...
public class CommandAccessMode extends CommandBase {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        tent.getPrivacy().setAccessMode(Privacy.AccessMode.valueOf(args[0].toUpperCase(Locale.ENGLISH)));
    }
